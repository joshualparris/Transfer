...
const lifeboat: LifeboatApi = {
  ...
  authorizeInventory: () => ipcRenderer.invoke("inventory-authorize"),
  ...
  pickBookshelfDestination: () => ipcRenderer.invoke("bookshelf-pick-destination"),
  scanBookshelf: () => ipcRenderer.invoke("bookshelf-scan"),
  rescueBookshelf: (value) => ipcRenderer.invoke("bookshelf-rescue", value),
  onBookshelfProgress: (fn) => listen("bookshelf-progress", fn),
