...
export default function CalendarPage({
  ...
  const source = data.accounts.find((a) => a.role === "source"),
    ...
    ].every((scope) => dest?.scopes.includes(scope)),
    s = data.calendar.stats,
    p = data.calendar.progress;
  return (
    <>
      <section className="panel">
        <div className="paneltitle">
          <div>
            <p className="eyebrow">PHASE 4 · CALENDAR</p>
            <h2>
      ...
      <section className="panel">
        <h3>Copy and independent backup</h3>
