...
try{
  ...
  const expected=['Overview','Activity & logs','Accounts','Inventory','Drive setup','Backup','Shared items','Verification','Gmail migration','Contacts migration','Calendar migration','Photos + Keep','Security','Final report'];
